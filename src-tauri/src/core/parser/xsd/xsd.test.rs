...
fn reads_palette() {
  ...
  let expected_palette = vec![
    PaletteItem {
      ...
      blends: None,
      bead: None,
      strands: Some(PaletteItemStitchStrands::default()),
    },
    PaletteItem {
    ...
    PaletteItem {
      ...
      blends: None,
      bead: Some(Bead { length: 1.5, diameter: 2.5 }),
      strands: Some(PaletteItemStitchStrands::default()),
    },
    PaletteItem {
      ...
      bead: None,
      strands: Some(PaletteItemStitchStrands {
        full: Some(StitchStrands::new(2)),
        petite: Some(StitchStrands::new(2)),
        half: Some(StitchStrands::new(2)),
        quarter: Some(StitchStrands::new(2)),
        back: Some(StitchStrands::new(2)),
        straight: Some(StitchStrands::new(2)),
        french_knot: Some(StitchStrands::new(2)),
        special: Some(StitchStrands::new(2)),
      }),
    },
  ];
  ...
  let expected_formats = vec![
    Formats {
      ...
      french: NodeFormat {
        ...
        use_alt_color: false,
        color: String::from("000000"),
        thickness: StitchThickness::new(4.0),
      },
      bead: NodeFormat {
        use_dot_style: true,
        use_alt_color: false,
    ...
    Formats {
      ...
      back: LineFormat {
        ...
        thickness: StitchThickness::new(1.5),
      },
      straight: LineFormat {
        use_alt_color: false,
        color: String::from("FFFFFF"),
        style: LineStyle::Dotted,
        thickness: StitchThickness::new(0.8),
      },
      french: NodeFormat {
        use_dot_style: false,
        use_alt_color: false,
      ...
      font: FontFormat {
        ...
        bold: false,
        italic: false,
        stitch_size: Percentage::new(80),
        small_stitch_size: Percentage::new(50),
      },
    },
  ];
